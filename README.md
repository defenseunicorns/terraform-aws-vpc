...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_vpc"></a> [vpc](#module\_vpc) | git::https://github.com/terraform-aws-modules/terraform-aws-vpc.git | v5.5.1 |
| <a name="module_vpc_endpoints"></a> [vpc\_endpoints](#module\_vpc\_endpoints) | git::https://github.com/terraform-aws-modules/terraform-aws-vpc.git//modules/vpc-endpoints | v5.5.1 |
...
| <a name="input_ip_offsets_per_subnet"></a> [ip\_offsets\_per\_subnet](#input\_ip\_offsets\_per\_subnet) | List of offsets for IP reservations in each subnet. | `list(list(number))` | `null` | no |
...
| <a name="output_module_vpc_default_vpc_arn"></a> [module\_vpc\_default\_vpc\_arn](#output\_module\_vpc\_default\_vpc\_arn) | The ARN of the Default VPC |
| <a name="output_module_vpc_default_vpc_cidr_block"></a> [module\_vpc\_default\_vpc\_cidr\_block](#output\_module\_vpc\_default\_vpc\_cidr\_block) | The CIDR block of the Default VPC |
| <a name="output_module_vpc_default_vpc_default_network_acl_id"></a> [module\_vpc\_default\_vpc\_default\_network\_acl\_id](#output\_module\_vpc\_default\_vpc\_default\_network\_acl\_id) | The ID of the default network ACL of the Default VPC |
| <a name="output_module_vpc_default_vpc_default_route_table_id"></a> [module\_vpc\_default\_vpc\_default\_route\_table\_id](#output\_module\_vpc\_default\_vpc\_default\_route\_table\_id) | The ID of the default route table of the Default VPC |
| <a name="output_module_vpc_default_vpc_default_security_group_id"></a> [module\_vpc\_default\_vpc\_default\_security\_group\_id](#output\_module\_vpc\_default\_vpc\_default\_security\_group\_id) | The ID of the security group created by default on Default VPC creation |
| <a name="output_module_vpc_default_vpc_enable_dns_hostnames"></a> [module\_vpc\_default\_vpc\_enable\_dns\_hostnames](#output\_module\_vpc\_default\_vpc\_enable\_dns\_hostnames) | Whether or not the Default VPC has DNS hostname support |
| <a name="output_module_vpc_default_vpc_enable_dns_support"></a> [module\_vpc\_default\_vpc\_enable\_dns\_support](#output\_module\_vpc\_default\_vpc\_enable\_dns\_support) | Whether or not the Default VPC has DNS support |
| <a name="output_module_vpc_default_vpc_id"></a> [module\_vpc\_default\_vpc\_id](#output\_module\_vpc\_default\_vpc\_id) | The ID of the Default VPC |
| <a name="output_module_vpc_default_vpc_instance_tenancy"></a> [module\_vpc\_default\_vpc\_instance\_tenancy](#output\_module\_vpc\_default\_vpc\_instance\_tenancy) | Tenancy of instances spin up within Default VPC |
| <a name="output_module_vpc_default_vpc_main_route_table_id"></a> [module\_vpc\_default\_vpc\_main\_route\_table\_id](#output\_module\_vpc\_default\_vpc\_main\_route\_table\_id) | The ID of the main route table associated with the Default VPC |
...
| <a name="output_reserved_ips_per_subnet"></a> [reserved\_ips\_per\_subnet](#output\_reserved\_ips\_per\_subnet) | Map of subnet IDs to their reserved IP addresses in dotted decimal notation. |
